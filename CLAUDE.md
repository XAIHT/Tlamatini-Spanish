...
- **Agents** — creating a new agent (8-step), naming conventions, lifecycle, all 86 agent types, FlowCreator, FlowHypervisor: @docs/claude/agents.md
