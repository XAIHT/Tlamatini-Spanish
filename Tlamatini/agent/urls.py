...
urlpatterns = [
    ...
    path('update_latexer_connection/<str:agent_name>/', secure_post(views.update_latexer_connection_view), name='update_latexer_connection'),
    ...
    path('update_netspeed_calculator_connection/<str:agent_name>/', secure_post(views.update_netspeed_calculator_connection_view), name='update_netspeed_calculator_connection'),
