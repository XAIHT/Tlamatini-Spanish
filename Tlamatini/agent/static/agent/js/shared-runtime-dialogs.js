...
(function (root) {
    ...
    function renderNotifierToast(notification) {
        ...
        const sourceAgent = notification.source_agent || notification.runtime_name || 'desconocido';
        ...
        dialogDiv.innerHTML = `
            ...
            <p><strong>Encontrado:</strong> <span style="background-color: ${severityBgColor}; padding: 2px 5px; border-radius: 3px; color: ${severityTextColor};">${escapeHtmlShared(matches)}</span></p>
            ${outcomeDetailHtml}
    ...
    async function renderAskerChoiceDialog(options) {
        ...
        dialogDiv.innerHTML = `
            <p style="text-align: center; font-size: 1.1em;">
                ¡<strong>${escapeHtmlShared(identifier)}</strong> necesita tu input!
            </p>
            <p style="text-align: center;">Elige un path para continuar:</p>
