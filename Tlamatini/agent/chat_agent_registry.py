...
WRAPPED_CHAT_AGENT_SPECS: tuple[ChatWrappedAgentSpec, ...] = (
    ...
    ChatWrappedAgentSpec(
        ...
        purpose=(
            ...
            "Report layout_clean from that block and NEVER call a document clean because the "
            "render did not error: PDFer re-opens the finished PDF and measures real glyph "
            "boxes, because three ordinary tables once produced 8 cell-on-cell overlaps while "
            "the engine reported zero errors every time. "
