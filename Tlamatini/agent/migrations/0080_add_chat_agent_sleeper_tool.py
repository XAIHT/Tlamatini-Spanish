...
WRAPPED_TOOL_DESCRIPTION = "Chat-Agent-Sleeper"


def add_chat_agent_sleeper_tool(apps, schema_editor):
...
def remove_chat_agent_sleeper_tool(apps, schema_editor):
    Tool = apps.get_model("agent", "Tool")
...
class Migration(migrations.Migration):
    dependencies = [
        ("agent", "0079_add_chat_agent_mouser_tool"),
    ]

    operations = [
        migrations.RunPython(add_chat_agent_sleeper_tool, remove_chat_agent_sleeper_tool),
    ]
