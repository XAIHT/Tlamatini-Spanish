...
WRAPPED_TOOL_DESCRIPTION = "Chat-Agent-Whisperer"


def add_chat_agent_whisperer_tool(apps, schema_editor):
...
def remove_chat_agent_whisperer_tool(apps, schema_editor):
    Tool = apps.get_model("agent", "Tool")
...
class Migration(migrations.Migration):
    dependencies = [
        ("agent", "0123_add_whisperer"),
    ]

    operations = [
        migrations.RunPython(add_chat_agent_whisperer_tool, remove_chat_agent_whisperer_tool),
    ]
