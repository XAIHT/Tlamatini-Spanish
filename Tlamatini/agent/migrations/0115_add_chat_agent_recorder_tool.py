...
WRAPPED_TOOL_DESCRIPTION = "Chat-Agent-Recorder"


def add_chat_agent_recorder_tool(apps, schema_editor):
...
def remove_chat_agent_recorder_tool(apps, schema_editor):
    Tool = apps.get_model("agent", "Tool")
...
class Migration(migrations.Migration):
    dependencies = [
        ("agent", "0114_add_recorder"),
    ]

    operations = [
        migrations.RunPython(add_chat_agent_recorder_tool, remove_chat_agent_recorder_tool),
    ]
