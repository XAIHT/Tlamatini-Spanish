...
WRAPPED_TOOL_DESCRIPTION = "Chat-Agent-VideoPlayer"


def add_chat_agent_videoplayer_tool(apps, schema_editor):
...
def remove_chat_agent_videoplayer_tool(apps, schema_editor):
    Tool = apps.get_model("agent", "Tool")
...
class Migration(migrations.Migration):
    dependencies = [
        ("agent", "0118_add_videoplayer"),
    ]

    operations = [
        migrations.RunPython(add_chat_agent_videoplayer_tool, remove_chat_agent_videoplayer_tool),
    ]
