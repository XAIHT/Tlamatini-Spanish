...
WRAPPED_TOOL_DESCRIPTION = "Chat-Agent-ESPHomer"


def add_chat_agent_esphomer_tool(apps, schema_editor):
...
def remove_chat_agent_esphomer_tool(apps, schema_editor):
    Tool = apps.get_model("agent", "Tool")
...
class Migration(migrations.Migration):
    dependencies = [
        ("agent", "0138_add_esphomer"),
    ]

    operations = [
        migrations.RunPython(add_chat_agent_esphomer_tool, remove_chat_agent_esphomer_tool),
    ]
