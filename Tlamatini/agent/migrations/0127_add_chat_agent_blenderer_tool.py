...
WRAPPED_TOOL_DESCRIPTION = "Chat-Agent-Blenderer"


def add_chat_agent_blenderer_tool(apps, schema_editor):
...
def remove_chat_agent_blenderer_tool(apps, schema_editor):
    Tool = apps.get_model("agent", "Tool")
...
class Migration(migrations.Migration):
    dependencies = [
        ("agent", "0126_add_blenderer"),
    ]

    operations = [
        migrations.RunPython(add_chat_agent_blenderer_tool, remove_chat_agent_blenderer_tool),
    ]
