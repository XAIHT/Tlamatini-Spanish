...
WRAPPED_TOOL_DESCRIPTION = "Chat-Agent-Windower"


def add_chat_agent_windower_tool(apps, schema_editor):
...
def remove_chat_agent_windower_tool(apps, schema_editor):
    Tool = apps.get_model("agent", "Tool")
...
class Migration(migrations.Migration):
    dependencies = [
        ("agent", "0093_add_windower"),
    ]

    operations = [
        migrations.RunPython(add_chat_agent_windower_tool, remove_chat_agent_windower_tool),
    ]
