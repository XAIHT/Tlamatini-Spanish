...
WRAPPED_TOOL_DESCRIPTION = "Chat-Agent-Mouser"


def add_chat_agent_mouser_tool(apps, schema_editor):
...
def remove_chat_agent_mouser_tool(apps, schema_editor):
    Tool = apps.get_model("agent", "Tool")
...
class Migration(migrations.Migration):
    dependencies = [
        ("agent", "0078_add_chat_agent_keyboarder_tool"),
    ]

    operations = [
        migrations.RunPython(add_chat_agent_mouser_tool, remove_chat_agent_mouser_tool),
    ]
