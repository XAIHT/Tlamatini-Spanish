...
WRAPPED_TOOL_DESCRIPTION = "Chat-Agent-STM32er"


def add_chat_agent_stm32er_tool(apps, schema_editor):
...
def remove_chat_agent_stm32er_tool(apps, schema_editor):
    Tool = apps.get_model("agent", "Tool")
...
class Migration(migrations.Migration):
    dependencies = [
        ("agent", "0101_add_stm32er"),
    ]

    operations = [
        migrations.RunPython(add_chat_agent_stm32er_tool, remove_chat_agent_stm32er_tool),
    ]
