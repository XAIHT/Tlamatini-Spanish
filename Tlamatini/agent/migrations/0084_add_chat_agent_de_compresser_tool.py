...
WRAPPED_TOOL_DESCRIPTION = "Chat-Agent-De-Compresser"


def add_chat_agent_de_compresser_tool(apps, schema_editor):
...
def remove_chat_agent_de_compresser_tool(apps, schema_editor):
    Tool = apps.get_model("agent", "Tool")
...
class Migration(migrations.Migration):
    dependencies = [
        ("agent", "0083_add_de_compresser"),
    ]

    operations = [
        migrations.RunPython(add_chat_agent_de_compresser_tool, remove_chat_agent_de_compresser_tool),
    ]
