...
WRAPPED_TOOL_DESCRIPTION = "Chat-Agent-J-Decompiler"


def add_chat_agent_j_decompiler_tool(apps, schema_editor):
...
def remove_chat_agent_j_decompiler_tool(apps, schema_editor):
    Tool = apps.get_model("agent", "Tool")
...
class Migration(migrations.Migration):
    dependencies = [
        ("agent", "0081_add_window_present_and_run_wait_tools"),
    ]

    operations = [
        migrations.RunPython(add_chat_agent_j_decompiler_tool, remove_chat_agent_j_decompiler_tool),
    ]
