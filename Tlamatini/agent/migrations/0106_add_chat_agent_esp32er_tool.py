...
WRAPPED_TOOL_DESCRIPTION = "Chat-Agent-ESP32er"


def add_chat_agent_esp32er_tool(apps, schema_editor):
...
def remove_chat_agent_esp32er_tool(apps, schema_editor):
    Tool = apps.get_model("agent", "Tool")
...
class Migration(migrations.Migration):
    dependencies = [
        ("agent", "0105_add_esp32er"),
    ]

    operations = [
        migrations.RunPython(add_chat_agent_esp32er_tool, remove_chat_agent_esp32er_tool),
    ]
