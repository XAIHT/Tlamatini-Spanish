...
WRAPPED_TOOL_DESCRIPTION = "Chat-Agent-Nmapper"


def add_chat_agent_nmapper_tool(apps, schema_editor):
...
def remove_chat_agent_nmapper_tool(apps, schema_editor):
    Tool = apps.get_model("agent", "Tool")
...
class Migration(migrations.Migration):
    dependencies = [
        ("agent", "0170_add_nmapper"),
    ]

    operations = [
        migrations.RunPython(add_chat_agent_nmapper_tool, remove_chat_agent_nmapper_tool),
    ]
