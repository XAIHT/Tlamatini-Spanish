...
WRAPPED_TOOL_DESCRIPTION = "Chat-Agent-Playwrighter"


def add_chat_agent_playwrighter_tool(apps, schema_editor):
...
def remove_chat_agent_playwrighter_tool(apps, schema_editor):
    Tool = apps.get_model("agent", "Tool")
...
class Migration(migrations.Migration):
    dependencies = [
        ("agent", "0091_add_playwrighter"),
    ]

    operations = [
        migrations.RunPython(add_chat_agent_playwrighter_tool, remove_chat_agent_playwrighter_tool),
    ]
