...
WRAPPED_TOOL_DESCRIPTION = "Chat-Agent-Unrealer"


def add_chat_agent_unrealer_tool(apps, schema_editor):
...
def remove_chat_agent_unrealer_tool(apps, schema_editor):
    Tool = apps.get_model("agent", "Tool")
...
class Migration(migrations.Migration):
    dependencies = [
        ("agent", "0085_add_unrealer"),
    ]

    operations = [
        migrations.RunPython(add_chat_agent_unrealer_tool, remove_chat_agent_unrealer_tool),
    ]
