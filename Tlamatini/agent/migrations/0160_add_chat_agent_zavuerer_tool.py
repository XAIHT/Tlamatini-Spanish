...
WRAPPED_TOOL_DESCRIPTION = "Chat-Agent-Zavuerer"


def add_chat_agent_zavuerer_tool(apps, schema_editor):
...
def remove_chat_agent_zavuerer_tool(apps, schema_editor):
    Tool = apps.get_model("agent", "Tool")
...
class Migration(migrations.Migration):
    dependencies = [
        ("agent", "0159_add_zavuerer"),
    ]

    operations = [
        migrations.RunPython(add_chat_agent_zavuerer_tool, remove_chat_agent_zavuerer_tool),
    ]
