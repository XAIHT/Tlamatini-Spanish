...
WRAPPED_TOOL_DESCRIPTION = "Chat-Agent-Keyboarder"


def add_chat_agent_keyboarder_tool(apps, schema_editor):
...
def remove_chat_agent_keyboarder_tool(apps, schema_editor):
    Tool = apps.get_model("agent", "Tool")
...
class Migration(migrations.Migration):
    dependencies = [
        ("agent", "0077_add_whatstlamatini"),
    ]

    operations = [
        migrations.RunPython(add_chat_agent_keyboarder_tool, remove_chat_agent_keyboarder_tool),
    ]
