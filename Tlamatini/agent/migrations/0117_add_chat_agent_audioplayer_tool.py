...
WRAPPED_TOOL_DESCRIPTION = "Chat-Agent-AudioPlayer"


def add_chat_agent_audioplayer_tool(apps, schema_editor):
...
def remove_chat_agent_audioplayer_tool(apps, schema_editor):
    Tool = apps.get_model("agent", "Tool")
...
class Migration(migrations.Migration):
    dependencies = [
        ("agent", "0116_add_audioplayer"),
    ]

    operations = [
        migrations.RunPython(add_chat_agent_audioplayer_tool, remove_chat_agent_audioplayer_tool),
    ]
