...
WRAPPED_TOOL_DESCRIPTION = "Chat-Agent-Discoverer"


def add_chat_agent_discoverer_tool(apps, schema_editor):
...
def remove_chat_agent_discoverer_tool(apps, schema_editor):
    Tool = apps.get_model("agent", "Tool")
...
class Migration(migrations.Migration):
    dependencies = [
        ("agent", "0149_add_discoverer"),
    ]

    operations = [
        migrations.RunPython(add_chat_agent_discoverer_tool, remove_chat_agent_discoverer_tool),
    ]
