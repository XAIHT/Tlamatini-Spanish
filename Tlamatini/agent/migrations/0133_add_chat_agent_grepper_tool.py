...
WRAPPED_TOOL_DESCRIPTION = "Chat-Agent-Grepper"


def add_chat_agent_grepper_tool(apps, schema_editor):
...
def remove_chat_agent_grepper_tool(apps, schema_editor):
    Tool = apps.get_model("agent", "Tool")
...
class Migration(migrations.Migration):
    dependencies = [
        ("agent", "0132_add_grepper"),
    ]

    operations = [
        migrations.RunPython(add_chat_agent_grepper_tool, remove_chat_agent_grepper_tool),
    ]
