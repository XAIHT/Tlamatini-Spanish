...
WRAPPED_TOOL_DESCRIPTION = "Chat-Agent-Talker"


def add_chat_agent_talker_tool(apps, schema_editor):
...
def remove_chat_agent_talker_tool(apps, schema_editor):
    Tool = apps.get_model("agent", "Tool")
...
class Migration(migrations.Migration):
    dependencies = [
        ("agent", "0120_add_talker"),
    ]

    operations = [
        migrations.RunPython(add_chat_agent_talker_tool, remove_chat_agent_talker_tool),
    ]
