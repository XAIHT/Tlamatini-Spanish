...
WRAPPED_TOOL_DESCRIPTION = "Chat-Agent-Globber"


def add_chat_agent_globber_tool(apps, schema_editor):
...
def remove_chat_agent_globber_tool(apps, schema_editor):
    Tool = apps.get_model("agent", "Tool")
...
class Migration(migrations.Migration):
    dependencies = [
        ("agent", "0135_add_globber"),
    ]

    operations = [
        migrations.RunPython(add_chat_agent_globber_tool, remove_chat_agent_globber_tool),
    ]
