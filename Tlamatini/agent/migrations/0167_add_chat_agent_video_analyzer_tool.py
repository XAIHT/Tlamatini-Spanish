...
WRAPPED_TOOL_DESCRIPTION = "Chat-Agent-Video-Analyzer"


def add_chat_agent_video_analyzer_tool(apps, schema_editor):
...
def remove_chat_agent_video_analyzer_tool(apps, schema_editor):
    Tool = apps.get_model("agent", "Tool")
...
class Migration(migrations.Migration):
    dependencies = [
        ("agent", "0166_add_video_analyzer"),
    ]

    operations = [
        migrations.RunPython(add_chat_agent_video_analyzer_tool, remove_chat_agent_video_analyzer_tool),
    ]
