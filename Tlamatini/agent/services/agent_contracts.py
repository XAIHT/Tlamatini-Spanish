...
_PARAMETRIZER_OUTPUT_FIELDS: dict[str, tuple[str, ...]] = {
    ...
    "reviewer": ("repo_path", "diff_ref", "verdict", "model", "status", "error", "response_body"),
    "analyzer": ("target_path", "tools_run", "tools_skipped", "total_findings", "min_severity", "status", "response_body"),
