...
Descarga el ZIP del release más reciente — **[Tlamatini v1.48.0](https://github.com/XAIHT/Tlamatini/releases/tag/v1.48.0)** — y descomprímelo (o usa una carpeta `Tlamatini_Release/` que alguien te haya pasado / que tú mismo hayas compilado — ve la Part VIII). Luego:
...
git tag -a v1.48.0 -m "Release 1.48.0: <one-liner>"   # annotated tag
...
Los tres scripts de build toman el tag de `git describe --tags` automáticamente. El artefacto final aterriza en `dist/Tlamatini_Release_v1.48.0/`, nombrado según la versión, para que el archivo que le entregues a un usuario sea inequívoco incluso antes de que lo descomprima.
...
- **Nombre de la carpeta de release** — `dist/Tlamatini_Release_v1.48.0/`.
