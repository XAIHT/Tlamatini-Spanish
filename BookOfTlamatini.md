...
>
> **Estado comprobado:** el release actual es `v1.51.3s` (`1339fc7`); `HEAD` y `origin/main` auditados están en `272d6ac`, cinco commits posteriores. La superficie viva contiene 88 workflow agents, 66 launchers `chat_agent_*`, 108 tools integradas de Multi-Turn, 105 tools del MCP stdio raíz, 29 skills, 198 migrations y 1,143 files tracked. La matriz source→docs y la separación release→desarrollo están en [`docs/estado-actual-v1.51.3s.md`](docs/estado-actual-v1.51.3s.md).
>
